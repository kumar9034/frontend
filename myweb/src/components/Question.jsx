...
const Question = () => {
    return (
        <>
            <div className='question h-auto w-full bg-[#333333] pb-20 '>
                ...
                <div className='line border-1 border-white w-[90%] ml-15 mt-15 '></div>
                <div className='question-no ml-15 mt-3 mr-20 flex justify-between items-center'>
                ...
                <div className='line border-1 border-white w-[90%] ml-15 mt-5 '></div>
                <div className='question-no ml-15 mt-3 mr-20 flex justify-between items-center'>
                ...
                <div className='box-1 h-27 w-[80%] bg-black mt-20 ml-30 flex justify-center items-center rounded-lg'>
