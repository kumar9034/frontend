    ...
    return (
        <div>
            ...
            <div className='w-ful h-auto flex flex-col  items-center pt-2 px-10 md:px-0 bg-[#222222]'>
                ...
                <div className='sm:w-[72rem] sm:h-14 h-10  w-[22rem] mt-5 flex  rounded-4xl bg-[#3e3e3e]'>
                    <CgSearch color='white' size={27} className='sm:mt-4 mt-2 sm:ml-5 ml-2 ' />
                    <input type="text" className='w-full text-[#aaaaaa] outline-none sm:ml-4 ml-2 sm:text-lg text-sm' placeholder='Search For Courses, language , framwork or teacher...' />
                </div>
            ...
            <div className='h-auto flex justify-center pb-10 px-5  w-full bg-[#222222] pt-15  '>
                <div className='sm:h-65 h-[30rem] sm:w-[74rem] w-full sm:flex  justify-between bg-gradient-to-r from-[#052749] via-[#052749] to-[#070216]" '>
                    ...
                    <div className=' sm:w-[70rem] w-full sm:h-full h-auto sm:px-10 px-5 pt-5'>
                ...
                <div className='h-auto pb-20 w-full bg-[#222222] '>
                    ...
                    <div className='border-1 sm:w-[74rem] w-[85%] border-[#3e3e3e] sm:ml-10 ml-5 mt-4'></div>
